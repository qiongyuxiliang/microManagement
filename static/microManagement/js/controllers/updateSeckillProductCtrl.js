angular.module('controllers',[]).controller('updateSeckillProductCtrl',
    ['$scope','$interval','$rootScope','$stateParams','$state','Global','$timeout','$http','ManagementUtil','FindProductDetail','GetSecKillActivityDetail','UpdateSecKillActivity',
        function ($scope,$interval,$rootScope,$stateParams,$state,Global,$timeout,$http,ManagementUtil,FindProductDetail,GetSecKillActivityDetail,UpdateSecKillActivity) {
             $scope.mess = false;
           ...
           $scope.addSession = function(index){
            ...
            $scope.submit = function(){
                ...
                $scope.SeckillActivityDTO.id = $stateParams.id;
              ...
              if($scope.SeckillActivityDTO.productNum==''||$scope.SeckillActivityDTO.activityName == ""||$scope.SeckillActivityDTO.productId==""||$scope.SeckillActivityDTO.startTime==""||$scope.SeckillActivityDTO.endTime==""||$scope.SeckillActivityDTO.favorablePrice==""||$scope.SeckillActivityDTO.activityNum==""||$scope.SeckillActivityDTO.isEnable==""){
                ...
                UpdateSecKillActivity.save($scope.SeckillActivityDTO,function(data){
